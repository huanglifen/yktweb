...
<div class="scent3">
    <div class="buy_left">
        <div style="margin-top:10px;margin-left : 15px;font-size:15px;font-weight: bold;">
            信息确认
        </div>
        <div class="buy_info">
            <form id="buyForm" action="javascript:void(0);">
                ...
                <div class="buy_input"><div class="buy_label"><label>短信验证：</label></div>
                    <input type="text" class="input_text small" name="code">
                ...
                <div class="buy_input"><div class="buy_label"><label>验证码：</label></div>
                    <input type="text" class="input_text small" name="yzCode">
    ...
    <div class="buy_left">
        <div class="buy_info">
            ...
            <div class="buy_input"><div class="buy_label"><label>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</label></div>
