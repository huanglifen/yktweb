...
<div class="gray_border title_box">
    ...
    <div class="help_menu_big">
    <div class="news_type">
        <a href="javascript:;">认识一卡通</a>
    </div>
        <div class="help_menu_small">一卡通卡介绍</div>
        <div class="help_menu_small">公司介绍</div>
    </div>
    <div class="help_menu_big">
    <div class="news_type">
        <a href="javascript:;">使用一卡通</a>
    </div>
    <div class="help_menu_small">去消费</div>
    <div class="help_menu_small">去缴费</div>
    </div>
</div>
                </div>
                <div class="news_right gray_border">
                    <div class="title03"> <?php echo ($help["title"]); ?></div>
                    <div class="title_fujia">
                        <span>时间:<?php echo ($help["created_at"]); ?></span>
                        <span>来源:<?php echo ($help["source"]); ?></span>
                        <span>编辑:<?php echo ($help["author"]); ?></span>
                        <span>点击次数:</span>
                    </div>
